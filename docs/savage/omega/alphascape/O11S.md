...
To resolve: OT will move to the North East corner to bait the Guided Missile Kyrios and use their invuln to tank all 6 attacks. The rest of the group will stack on the south side of the bosses' hotbox and move in the same manner as before. When running CCW, the group will need to check the direction that the cone AoEs are going. If they are also going CCW, the group can just dodge the AoEs. However, if the AoEs are moving CW, the group may need to double back to ensure they are running in the same direction.

Condensed Wave Cannon is a stack marker soaked by everyone but the tanks. The tanks will instead be targeted with more cone attacks, so all other players must be away from the tanks. The tanks can stand NE and NW from the boss to take these.
